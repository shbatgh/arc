...
def kochanek_bartels_spline_nonuniform(P0, P1, P2, P3, tension=0.0, continuity=0.0, bias=0.0, num_points=1000):
    ...
    if np.isclose(t2, t1):
        # Degenerate case: zero arc length between P1 and P2
        # Just duplicate the point to form a flat line
...
def v_for_u_nonuniform(target_u, P0, P1, P2, P3, tension=0.0, continuity=0.0, bias=0.0, tol=1e-0):
