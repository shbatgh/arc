...
"""
import sys
sys.path.append("/home/sam/miniconda3/lib/python3.13/site-packages")
...
def render():
    ...
    cur_render_col = bpy.data.collections.new(header + ' Rendering '+str(cur_render_number))                 #Collection for each time a file is rendered. All tps are added to it
            ...
            if area.type == 'VIEW_3D':
                for region in area.regions:
                    if region.type == 'WINDOW':
                        # Use temp_override for Blender 3.2+ compatibility
