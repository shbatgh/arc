...
def find_3D_center(cell_obj): #Finds the center of a 3D cell. averages all the x and y points in all outlines, then finds the middle slice for the z
    ...
    z = (cell_obj.top_slice + cell_obj.starting_slice) * 0.5 * (3/0.198)      #Finds middle slice. Later, maybe rework with the math that incorporates top and bottom outlines' radii
