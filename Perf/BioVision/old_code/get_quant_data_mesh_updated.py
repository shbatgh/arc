...
def get_solid_mesh_objs(cell3D, points_per_segment=points_per_segment, pitch = pitch):        #FIX THIS UP
    mesh_objs = []
    ...
    for single_tp_cell in cell3D.cells_list:
        ...
        for idx in range(len(single_tp_cell.outlines)):     #Make 2D slice outlines 3D
            ...
            for coord in outline_2D:
                surface_points.append([coord[0], coord[1], (single_tp_cell.starting_slice+idx)*3/0.198])
...
def export_tracers(cells3D):
    ...
    with open("C:/Users/areil/Desktop/Terra/Programs/Program Outputs/tracers.txt", 'w') as f:
        f.write("TRACER\n")
        f.write(str(tracers))
...
colors= [(255,0,0), (0,0,255), (0,255,255), (255,0,255), (200,200,0), (200,0,100), (0,100,0), (150,50,50), (255,200,100)]      #(255,0,0), (0,0,255), (0,255,255), (255,0,255), (200,200,0), (200,0,100), (0,100,0), (150,50,50), (255,200,100)
...
for col in colors:
    print(col)
    cur_cells = animation_cell_matching.get_raw_cell_data(path = "C:/Users/areil/Desktop/Terra/Programs/Program Outputs/ForTaraPos10.txt",
                                                          color = col)
...
#export_solid_meshs(cells3D=cells3D, points_per_segment=points_per_segment, output_path='C:/Users/areil/Desktop/Terra/Programs/Program Outputs/solid_meshes ForTaraPos10.txt')